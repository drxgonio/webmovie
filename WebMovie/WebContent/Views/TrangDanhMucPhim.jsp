		...
		<div class="row" id="row_main">
				...
				<form action="#"
				  ...
				  <div class="nav-wrapper">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link " href="TrangQuanLyPhim.jsp">
                             <i class="material-icons">edit</i>
                             <span>Quản lý phim</span>
                             </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link active " href="TrangDanhMucPhim.jsp">
			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
				 ...
				 <div class="col">
                    <a href="/WebMovie/Views/ThemDanhMucPhim.jsp" class="btn btn-info mb-3 " role="button">Thêm Danh Mục Phim + </a>
                  </div>
				<div class="row">
							...
							<div class="card-body p-0 pb-3 text-center table-responsive">
								...
								<table class="table mb-0">
									...
									<thead class="bg-light">
										...
										<tr>
											<th scope="col" class="border-0">STT
											 </th>
									...
									%>
										<tr>
											...
											<th scope="col" class="border-0"><%=c.getMoTa() %></th>
											 ...
											 <td>
                                              <a href="/WebMovie/Views/UpdateDanhMucPhim.jsp?command=update&id=<%=c.getId()%>&tenDanhMuc=<%=c.getTenDanhMuc() %>&moTa=<%=c.getMoTa() %>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                              <a href="/WebMovie/DanhMucPhimServlet?command=delete&id=<%=c.getId()%>" class="btn btn-danger" ">
